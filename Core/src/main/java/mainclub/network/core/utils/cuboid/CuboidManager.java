package mainclub.network.core.utils.cuboid;
...
public class CuboidManager implements Iterable<Location> {
     ...
     */
    public CuboidManager(Location l1, Location l2) {
     ...
     */
    public CuboidManager(World world, int x1, int y1, int z1, int x2, int y2, int z2) {
     ...
     * @param z2        Z coord of corner 2
     */
    private CuboidManager(String worldName, int x1, int y1, int z1, int x2, int y2, int z2) {
     ...
     */
    public CuboidManager expand(CuboidDirection dir, int amount) {
        switch (dir) {
            case NORTH:
                return new CuboidManager(worldName, x1 - amount, y1, z1, x2, y2, z2);
            case SOUTH:
                return new CuboidManager(worldName, x1, y1, z1, x2 + amount, y2, z2);
            case EASY:
                return new CuboidManager(worldName, x1, y1, z1 - amount, x2, y2, z2);
            case WEST:
                return new CuboidManager(worldName, x1, y1, z1, x2, y2, z2 + amount);
            case DOWN:
                return new CuboidManager(worldName, x1, y1 - amount, z1, x2, y2, z2);
            case UP:
                return new CuboidManager(worldName, x1, y1, z1, x2, y2 + amount, z2);
            default:
                throw new IllegalArgumentException("invalid direction " + dir);
        }
    }
    public CuboidManager expandAll(int amount) {
        return new CuboidManager(worldName, x1 - amount, y1 - amount, z1 - amount, x2 + amount, y2 + amount, z2 + amount);
    }
     ...
     */
    public CuboidManager shift(CuboidDirection dir, int amount) {
     ...
     */
    private CuboidManager outset(CuboidDirection dir, int amount) {
        CuboidManager c;
        switch (dir) {
            case HORIZONTAL:
     ...
     */
	/*
	public CuboidManager inset(CuboidDirection dir, int amount) {
     ...
     */
    public CuboidManager getFace(CuboidDirection dir) {
        switch (dir) {
            case DOWN:
                return new CuboidManager(worldName, x1, y1, z1, x2, y1, z2);
            case UP:
                return new CuboidManager(worldName, x1, y2, z1, x2, y2, z2);
            case NORTH:
                return new CuboidManager(worldName, x1, y1, z1, x1, y2, z2);
            case SOUTH:
                return new CuboidManager(worldName, x2, y1, z1, x2, y2, z2);
            case EASY:
                return new CuboidManager(worldName, x1, y1, z1, x2, y2, z1);
            case WEST:
                return new CuboidManager(worldName, x1, y1, z2, x2, y2, z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
     ...
     */
    public CuboidManager getBoundingCuboidManager(CuboidManager other) {
        if (other == null) {
            return this;
        }
        ...
        return new CuboidManager(worldName, xMin, yMin, zMin, xMax, yMax, zMax);
    }
